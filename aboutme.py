...
def main():
    data = {
        'full_name': 'Ayush Gajipara',
        'student_id': 10332299,
        'pizza_toppings': ['JALEPENO', 'MUSHROOMS', 'RED ONIONS'],
        'movies': [
    ...
    data['movies'].append({'title': 'inception', 'genre': 'sci-fi'})
    ...
    add_pizza_toppings(data, ('TOMATOES', 'BANANA PEPPERS'))
